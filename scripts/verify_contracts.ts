...
const LightmEquippableMultiAssetFacetAddr = '0xffBA44B1dA0145F2Eae7498461082923352E3608';
const LightmEquippableNestableFacetAddr = '0x327384513662d4EFb7bdd522b88768D845BA956c';
...
(async function () {
  const toBeVerifiedArr = [
    ...
    // LightmEquippableNestableFacet 0.1.0-alpha
    {
      ...
      constructorArguments: ['LightmEquippableNestable-0.1.0-alpha', 'RMRKEN-0.1.0-alpha'],
    },
